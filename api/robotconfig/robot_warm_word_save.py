...
class RobotWarmWordSave:

    @staticmethod
    def warm_word_save(url, params, assert_value):
        path = "/robotConfig/robotCfg/config/warmWordsSave"
        header = {
...
#         {"robotId": "709", "guideResponseEnable": "true", "guideWordList": [], "userId": "11"}), "code-8")#     actual_result, except_result = RobotAdd().add_robot("https://tkf-kicp.kuaishang.cn", json.dumps(
