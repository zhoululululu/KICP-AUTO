...
@File  : robot_artiticial_settings_save.py
@author: ZL
@Desc  :
'''
import requests
...
class RobotArtiticialSettingsSave:

    @staticmethod
    def artiticial_settings_save(url, params, assert_value):
        path = "/robotConfig/robotCfg/config/artificialSave"
        header = {
...
#     actual_result, expect_result = Robotartiticial_settingssave().artiticial_settings_save("https://tkf-kicp.kuaishang.cn", json.dumps(
#         {"robotId": "709", "normalartiticial_settingsEnable": "true",
#          "normalartiticial_settingsContent": "<div>zl-专用查询机器人配置（非空）-通用问候语内容A</div>", "keywordartiticial_settingsEnable": "false",
#          "keywordartiticial_settingsContent": "<div>zl-专用查询机器人配置（非空）-关键词问候语内容A</div>", "userId": "11"}), "code-8")
