...
#         json.dumps({"data": json.dumps({"question": "zl-test分类测试问题2", "categoryId": "895",
#                                         "similarQuestionforms": [{"question": "zl-test分类测试问题2-1"}],
#                                         "answerForms": [
#                                             {"content": "<div>zl-test分类测试回答2</div>",
#                                              "condition": "[{\"action\":\"include\",\"type\":\"input\",\"content\":\"分类测试\"}]"}],
#                                         "effectiveType": 0, "sourceType": 0, "enable": "true", "userId": "11",
#                                         "robotId": "877"})}
#                    ),
#         'code-8')
#     print(actual_result)
